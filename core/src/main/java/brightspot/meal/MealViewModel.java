...
import com.psddev.styleguide.meal.MealView;
import com.psddev.styleguide.meal.MealViewCoursesField;
import com.psddev.styleguide.meal.MealViewLeadField;
import com.psddev.styleguide.meal.MealViewPageDescriptionField;
import com.psddev.styleguide.meal.MealViewPageTitleField;
...
public class MealViewModel extends ViewModel<Meal> implements MealView, PageEntryView, PreviewEntryView {

    @Override
    public Iterable<? extends MealViewCoursesField> getCourses() {
        return createViews(MealViewCoursesField.class, model.getCourses());
    }
    ...
    @Override
    public Iterable<? extends MealViewLeadField> getLead() {
        return createViews(MealViewLeadField.class, model.getLead());
    }

    @Override
    public Iterable<? extends MealViewPageDescriptionField> getPageDescription() {
        return RichTextUtils.buildHtml(
            model,
            Meal::getPageDescription,
            e -> createView(MealViewPageDescriptionField.class, e));
    }

    @Override
    public Iterable<? extends MealViewPageTitleField> getPageTitle() {
        return RichTextUtils.buildHtml(
            model,
            Meal::getPageTitle,
            e -> createView(MealViewPageTitleField.class, e));
    }
